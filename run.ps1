...
Write-Host "Git commands: add, commit <message>, push, new-branch <branch-name>, checkout <branch-name>, pull, merge <branch-name>, hard-reset [target], soft-reset [target], status, log, stash, stash-pop, branch"